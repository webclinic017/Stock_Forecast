...
def get_model_data(industry=True, trade_value=True, load_file=False):
    ...
    # TEJ ewtinst1 - Average Holding Cost of Juridical Persons ......
    if market == 'tw':
    ...
    chk_na_min = chk_na['NA_COUNT'].min()
    chk_na_max = chk_na['NA_COUNT'].max()

    assert len(chk_na) < 100 or chk_na_min == chk_na_max, \
        'get_model_data - Check hist_df NA'
