...
def get_model_data(industry=True, trade_value=True):
    ...
    # S&P 500 ......
    snp, cols = sam_opd_get_snp_data(begin_date=shift_begin, 
...
def sam_opd_get_snp_data(begin_date, end_date):
    
    
    global ma_values, predict_period
    loc_df = stk.opd_get_snp_data(daily_backup=True, path=path_temp)
