...
def get_market_data_raw(industry=True, trade_value=True, support_resist=False):
    ...
    # - market_data會在這裡merge calendar，所以market_data必須
    ...
    #     market_data = market_data.drop('WORK_DATE', axis=1)
    #     cols = cbyz.df_get_cols_except(df=market_data,
    #                                    except_cols=id_keys)
        
    #     market_data, _ = \
    #         cbyz.df_summary(df=market_data, cols=cols, group_by=id_keys, 
