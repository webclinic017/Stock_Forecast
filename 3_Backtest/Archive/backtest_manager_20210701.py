...
def cal_profit(y_thld=2, time_thld=10, rmse_thld=0.15, 
    ...
    new_cols = cols_1 + profit_cols + model_y + model_y_last + cols_2
    ...
    for y in model_y:
        ...
        # MAPE2
        new_mape2 = cbyz.summary(df=mape_main, group_by='OVERESTIMATE', 
                             cols='MAPE')
        mape2 = mape2.append(new_mape2)
...
def master(_bt_last_begin, predict_period=14, interval=360, bt_times=5, 
    ...
    global bt_main, actions, mape, mape2
