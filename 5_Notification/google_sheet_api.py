...
gc = pygsheets.authorize(service_file=path \
                           +'/stock-forecast-20210520-d92b6538031a.json')
    
    

sh = gc.open_by_url(url)

search = sh.worksheet('title', 'Ledger')
...
info_path = '/Users/Aron/Documents/GitHub/Data/Stock_Analysis/5_Notification'
info_path = '/Users/Aron/Documents/black_box'
